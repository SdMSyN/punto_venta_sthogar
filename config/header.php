...
<link rel="pingback" href="<?php bloginfo( 'pingback_url' ); ?>">
	...
	<!-- Bootstrap -->
	<link href="../../../../cotizador2/assets/css/application.css" rel="stylesheet">

	<!-- jQuery -->
	<script src="../../../../cotizador2/assets/js/jquery.min.js"></script>
	<script src="../../../../cotizador2/assets/js/bootstrap.min.js"></script>

	<!-- jValidate -->
	<script src="../../../../cotizador2/assets/js/jquery.validate.min.js"></script>
	<script src="../../../../cotizador2/assets/js/jquery-validate.bootstrap-tooltip.min.js"></script>
