    ...
    <div class="row" >
      ...
      //Obtenemos datos de la tienda
        ...
        $cad.='<p class="text-center" style="font-size: 7px; ">"Soluciones Tecnológicas para el Hogar"<br>'
			.'www.st-hogar.com, e-mail: contacto@st-hogar.com<br>'
			.'ST-Store: C. Miguel Hernández No. 403-local 2, Tepetlapa, Tlax.<br>'
			.'Cel: 246-116-3637 | Cel: 246-177-6355 | Oficina: 246-464-8317 </p>';
