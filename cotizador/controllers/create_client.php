...
$sqlCreateClient = "INSERT INTO $tClients (nombre, ap, am, calle, numero, "
        . "colonia, municipio, estado, telefono, celular, correo, rfc, "
        . "porc_desc, creado, actualizado, franq) "
        . "VALUES ('$inputNombre', '$inputAP', '$inputAM', '$inputStreet', '$inputNum', "
        . "'$inputCol', '$inputMun', '$inputEdo', '$inputTel', '$inputCel', '$inputMail', '$inputRFC', "
        . "'$inputPorcDesc', '$dateNow', '$dateNow', '$inputFranq' ) ";
