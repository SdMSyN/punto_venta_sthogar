...
$sqlUpdateClient = "UPDATE $tClients SET nombre='$inputNombre', ap='$inputAP', "
        . "am='$inputAM', calle='$inputStreet', numero='$inputNum', colonia='$inputCol', "
        . "municipio='$inputMun', estado='$inputEdo', telefono='$inputTel', celular='$inputCel', "
        . "correo='$inputMail', rfc='$inputRFC', porc_desc='$inputPorcDesc', "
        . "actualizado='$dateNow $timeNow', franq='$inputFranq' WHERE id='$idClient' ";
