...
$sqlGetCategories = "SELECT id, nombre, img FROM categorias WHERE activo='1' ORDER BY nombre ";
...
<div class="row">
    <div class="col-xs-5 sales sales-izquierda">
        <div class="ticket text-center">
            <form id="formTicket" method="POST" action="" >
                ...
                <input type="hidden" name="mayoreo" value="true"> 
                ...
                <div class="cobrar row">
                    ...
                    <div class="form-group col-xs-5">
                        <label>Cotizador (Ventas):</label></br>
                        <a href="form_price.php" class="btn btn-primary"><i class="fa fa-money" style="font-size: 2.2rem;"></i></a>
                    </div>
                </div>
                <div class="line"></div>
    ...
    <div class="col-sm-7 sales sales-derecha text-center">
        <div class="titulo-crud2">
            Cotizador MAYOREO<span class="tipoPrecio" style="font-size: 14px"><i></i></span>
        </div>
    ...
    $(document).ready(function () {
                ...
                success: function (msg) {
                    if (msg == "false") {
                        $.ajax({
                            ...
                            data: {idCategory: category, tarea: "catProduct", idPerfil: idPerfilPHP, idStore: idStore, mayoreo : true },
        ...
        $(".productInfo").on("click", ".clickProduct", function () {
            ...
            $.ajax({
                ...
                data: {idProduct: product, idPerfil: idPerfilPHP, mayoreo : true },
                success: function (msg) {
