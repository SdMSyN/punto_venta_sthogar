                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        success: function (msg) {
                            ...
                            if(msg.error == 0){
                                if(msg.perfil == 1) location.href="cotizador/index_admin.php";
                                else if(msg.perfil == 2) location.href="cotizador/form_price.php";
                                else if(msg.perfil == 3) location.href="cotizador/form_price.php";
                                else location.href="#";
                            }else{
